...
namespace TransportCompany.models
{
    public class Service
    {
        ...
        public Service(string serviceName, string employeeName, int serviceCost, DateTime serviceDate, string certificateNum, string contractNum)
        {
        ...
        public DateTime ServiceDate { get => _serviceDate; set => _serviceDate = value; }
